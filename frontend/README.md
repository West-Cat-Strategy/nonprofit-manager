...
For detailed architecture, see [https://github.com/example/nonprofit-manager](https://github.com/example/nonprofit-manager).
...
- [https://github.com/example/nonprofit-manager](https://github.com/example/nonprofit-manager) — Component architecture, state management
...
- [https://github.com/example/nonprofit-manager](https://github.com/example/nonprofit-manager) — Component structure and patterns
- [NEO-BRUTALIST-GUIDE.md](NEO-BRUTALIST-GUIDE.md) — Design system
