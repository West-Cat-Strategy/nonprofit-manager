...
export const GRANT_AWARD_STATUSES = ['active', 'on_hold', 'completed', 'closed', 'expired'] as const;
...
export interface UpdateGrantApplicationStatusDTO {
  status: Exclude<GrantApplicationStatus, 'draft'>;
  reviewed_at?: string | null;
  decision_at?: string | null;
  approved_amount?: number | null;
  outcome_reason?: string | null;
...
export interface GrantApplicationAwardResult {
