/**
 * MODULE-OWNERSHIP: external service providers page
 *
 * Canonical external-service-providers implementation for feature-owned engagement routes.
 */
...
<<<<<<< HEAD
            ...
            <div className="space-y-3">
              {providers.map((provider) => (
                <div key={provider.id} className="border-2 border-app-border p-4 bg-app-surface">
