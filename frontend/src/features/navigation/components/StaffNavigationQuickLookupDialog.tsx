...
import { useStaffQuickLookup } from '../hooks/useStaffQuickLookup';

interface StaffNavigationQuickLookupDialogProps {
  onClose: () => void;
}
...
export default function StaffNavigationQuickLookupDialog({
  onClose,
}: StaffNavigationQuickLookupDialogProps) {
  const navigate = useNavigate();
  const lookup = useStaffQuickLookup({ debounceMs: 250 });
