...
export const fetchAnalyticsSummary = createAsyncThunk(
  ...
  async (filters?: AnalyticsFilters) => {
    return analyticsApiClient.fetchSummary(filters);
  }
);
...
export const fetchAccountAnalytics = createAsyncThunk(
  ...
  async (accountId: string) => {
    return analyticsApiClient.fetchAccountAnalytics(accountId);
  }
);
...
export const fetchContactAnalytics = createAsyncThunk(
  ...
  async (contactId: string) => {
    return analyticsApiClient.fetchContactAnalytics(contactId);
  }
);
...
export const fetchAccountDonationMetrics = createAsyncThunk(
  ...
  async (accountId: string) => {
    return analyticsApiClient.fetchAccountDonationMetrics(accountId);
  }
);
...
export const fetchContactDonationMetrics = createAsyncThunk(
  ...
  async (contactId: string) => {
    return analyticsApiClient.fetchContactDonationMetrics(contactId);
  }
);
...
export const fetchAccountEventMetrics = createAsyncThunk(
  ...
  async (accountId: string) => {
    return analyticsApiClient.fetchAccountEventMetrics(accountId);
  }
);
...
export const fetchContactEventMetrics = createAsyncThunk(
  ...
  async (contactId: string) => {
    return analyticsApiClient.fetchContactEventMetrics(contactId);
  }
);
...
export const fetchContactVolunteerMetrics = createAsyncThunk(
  ...
  async (contactId: string) => {
    return analyticsApiClient.fetchContactVolunteerMetrics(contactId);
  }
);
...
export const fetchDonationTrends = createAsyncThunk(
  ...
  async (months: number = 12) => {
    return analyticsApiClient.fetchDonationTrends(months);
  }
);
...
export const fetchVolunteerHoursTrends = createAsyncThunk(
  ...
  async (months: number = 12) => {
    return analyticsApiClient.fetchVolunteerHoursTrends(months);
  }
);
...
export const fetchEventAttendanceTrends = createAsyncThunk(
  ...
  async (months: number = 12) => {
    return analyticsApiClient.fetchEventAttendanceTrends(months);
  }
);
...
export const fetchComparativeAnalytics = createAsyncThunk(
  ...
  async (period: 'month' | 'quarter' | 'year' = 'month') => {
    return analyticsApiClient.fetchComparativeAnalytics(period);
  }
);
