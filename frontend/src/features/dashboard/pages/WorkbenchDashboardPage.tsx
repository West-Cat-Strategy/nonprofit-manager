...
function WorkbenchDashboardContent() {
  ...
  return (
    <NeoBrutalistLayout pageTitle="WORKBENCH">
      <div className="mx-auto max-w-7xl px-0 pb-6 pt-2 sm:py-6">
        <PageHeader
          badge={
            <span className="rounded-[var(--ui-radius-sm)] border border-app-border-muted bg-app-surface-elevated px-3 py-1 text-xs font-semibold text-app-text-muted shadow-sm">
              Staff workspace
            </span>
          }
          title="Workbench"
          description="Start with urgent work, assigned follow-ups, portal requests, and the operational signals that need attention today."
          actions={
            primaryAction ? (
              <Link
