...
export default function DashboardSection({
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="space-y-2">
          ...
          <p className="max-w-3xl text-sm text-app-text-muted">
            Start from the type of work you need to do, then jump into the right settings section or
            specialist admin workspace without losing the shared admin context.
          </p>
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        <div aria-label="Loading admin status" role="status" className="flex justify-center p-12">
                ...
                >
                  <div className="mb-3 flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-base font-semibold text-app-text-heading">
                          {card.title}
                        </h4>
