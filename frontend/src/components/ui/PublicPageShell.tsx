...
export default function PublicPageShell({
  ...
  return (
    <div className="app-shell app-shell--public relative min-h-screen overflow-hidden bg-gradient-to-br from-app-bg via-app-shell-top to-app-accent-soft/30 text-app-text">
      <SkipLink targetId="public-main-content" />
      <div
        aria-hidden="true"
      ...
      <main id="public-main-content" className="relative mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
        <header className="app-shell-panel rounded-[var(--ui-radius-lg)] border border-app-border-muted bg-app-surface-elevated/92 p-6 shadow-[var(--ui-elev-2)] backdrop-blur sm:p-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              ...
              <h1
                id={titleId}
                className="font-display mt-3 text-3xl font-semibold text-app-text-heading sm:text-4xl"
              >
                {title}
              </h1>
