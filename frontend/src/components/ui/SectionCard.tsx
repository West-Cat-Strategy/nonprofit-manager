  ...
  return (
    <section
      className={classNames(
        'rounded-[var(--ui-radius-sm)] border border-app-border-muted bg-app-surface p-4 shadow-sm sm:p-5',
        className
      )}
    >
      {(title || subtitle || actions) && (
        <header className="mb-4 flex flex-wrap items-start justify-between gap-3 border-b border-app-border-muted pb-3">
