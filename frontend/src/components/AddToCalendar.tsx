  ...
  return (
    <div className={`relative inline-block ${className}`} ref={dropdownRef}>
      <button
        ...
        className="inline-flex items-center gap-2 px-4 py-2 bg-app-accent text-[var(--app-accent-foreground)] rounded-lg hover:bg-app-accent-hover transition-colors focus:outline-none focus:ring-2 focus:ring-app-accent focus:ring-offset-2"
      >
        <svg
          className="w-5 h-5"
          fill="none"
