 ...
 * Social media sharing buttons for events and content
 */
        ...
        <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
          {shareOptions.map((option) => (
            <a
              ...
              className={`flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:text-white transition-colors ${option.color}`}
