...
export default function ResetPassword() {
  ...
  const renderContent = () => {
    switch (status) {
      case 'loading':
        return <p className="text-sm text-app-text">Validating your reset link...</p>;
      ...
      case 'success':
        return (
          <div className="space-y-4">
            ...
            <Link
              to="/login"
              className="inline-flex w-full items-center justify-center rounded-xl bg-app-text px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-slate-900/20 transition hover:-translate-y-0.5 hover:bg-app-text focus:outline-none focus:ring-4 focus:ring-app-accent"
            >
              Sign In
            </Link>
          </div>
    ...
    <div className="auth-page-light relative min-h-screen overflow-hidden bg-gradient-to-br from-app-bg via-white to-app-accent-soft font-body">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-md items-center px-4 py-12">
        <div className="w-full rounded-3xl border border-app-border/80 bg-white/90 p-8 shadow-xl backdrop-blur">
          ...
          <p className="mt-2 text-sm text-app-text">Choose a new secure password for your account.</p>
