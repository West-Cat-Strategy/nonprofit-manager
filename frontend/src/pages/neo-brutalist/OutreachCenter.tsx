...
export default function OutreachCenter() {
    ...
    const handleNewItem = () => console.log('Open New Item Modal');
    const handleNewBlast = () => console.log('Create New Blast');
    const handleViewReports = () => console.log('View Reports');
    const handleManageEvent = (id: string) => console.log(`Manage Event ${id}`);
