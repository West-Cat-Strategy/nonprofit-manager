        ...
        <NeoBrutalistLayout pageTitle="WORKBENCH OVERVIEW">
            <div className="p-6">
                ...
                <div className="mb-6 flex justify-between items-center gap-4">
                    ...
                    <button className="px-6 py-2 bg-[#4DD0E1] text-black border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] transition-all font-bold uppercase">
                        + NEW ITEM
                    </button>
                </div>

                {/* "Hello, Community Builder" Banner - YELLOW */}
                <div className="bg-[#FFD700] border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-8 mb-6">
                    <div className="flex justify-between items-center">
                        <div className="flex-1">
                            ...
                            <p className="text-lg font-medium">
                                You have{' '}
                                <span className="font-bold border-2 border-black px-3 py-1 bg-white inline-block shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                            ...
                            <div className="mt-6 flex gap-4">
                                ...
                                <Link to="/people">
                                    <button className="px-6 py-3 bg-black text-white border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:bg-gray-800 font-bold uppercase">
                                        REVIEW PEOPLE
                                    </button>
                                </Link>
                            </div>
                ...
                <div className="bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Link to="/linking">
                            <div className="bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-6 hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all cursor-pointer">
