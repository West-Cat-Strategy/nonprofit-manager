...
export const publicRouteCatalogEntries: readonly RouteCatalogEntry[] = [
  ...
  publicRoute({
    id: 'public-report-snapshot-legacy-token',
    title: 'Public Report Snapshot Legacy Link',
    section: 'Auth',
  ...
  publicRoute({
    ...
    section: 'Auth',
    path: '/public/case-forms',
    auditFixtureKey: 'public-case-form',
  }),
  publicRoute({
    id: 'public-case-form-legacy-token',
    title: 'Public Case Form Legacy Link',
    section: 'Auth',
