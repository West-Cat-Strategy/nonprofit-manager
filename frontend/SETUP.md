...
```bash
git clone https://github.com/example/nonprofit-manager.git
...
For detailed component architecture, see [https://github.com/example/nonprofit-manager](https://github.com/example/nonprofit-manager).
...
2. **Read guides**:
   - [https://github.com/example/nonprofit-manager](https://github.com/example/nonprofit-manager) — Component structure
   - [CONVENTIONS.md](../docs/development/CONVENTIONS.md) — Code style
   - [NEO-BRUTALIST-GUIDE.md](NEO-BRUTALIST-GUIDE.md) — Design system
3. **Find an issue**: Check [GitHub Issues](https://github.com/example/nonprofit-manager/issues?label=good%20first%20issue) for beginner-friendly tasks
...
**Questions?**
- See [https://github.com/example/nonprofit-manager](https://github.com/example/nonprofit-manager) for component design
...
- [frontend/https://github.com/example/nonprofit-manager](https://github.com/example/nonprofit-manager) — Component structure and patterns
