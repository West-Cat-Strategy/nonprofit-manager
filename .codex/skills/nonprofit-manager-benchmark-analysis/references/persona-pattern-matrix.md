...
| Fundraiser | Contact hub, campaign segmentation, gift tracking, acknowledgment and membership depth, workflow automation | CiviCRM, ERPNext, SuiteCRM, OpenPetra | Strengthen donor segmentation, stewardship cadence support, campaign flows, and finance-linked gift review |
...
| Case Manager | Role-aware case stages, approvals, activity-driven follow-ups, grievance-aware handoffs | OpenSPP, CiviCRM | Strengthen explicit case stages, handoff packets, reassessment gates, and service continuity cues |
| Rehab Worker | Field-work tasks, service points, referrals, lightweight self-service and coordination views | OpenSPP, Sahana Eden, CiviCRM | Strengthen service coordination, referral and authorization transitions, and role-appropriate frontline vocabulary |
