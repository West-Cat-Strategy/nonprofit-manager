...
| Houdini | Nonprofit-native fundraising infrastructure, donation, recurring giving, crowdfunding, and payment-flow comparison | AGPL/custom exception posture; reference-only, no source copying |
| OpenBoxes | Healthcare and disaster-response inventory, shipment, warehouse, and stock-movement workflows | EPL-1.0; architecture-only until a license/reuse review says otherwise |
| KoboToolbox KPI | Humanitarian field forms, sharing, reports, and export workflows | AGPL-3.0; reference-only, no source copying |
| DHIS2 Core | Program indicators, organization units, analytics APIs, and monitoring/evaluation vocabulary | BSD-3-Clause but large platform; architecture-only unless a future row approves narrow attributed reuse |
| OpenMRS Core | Encounter, concept dictionary, and structured service-evidence modeling for health or rehab-adjacent workflows | MPL-2.0; architecture-only and not an EMR adoption plan |
| openIMIS backend and Docker distribution | Eligibility, claims, contributions, payments, and social-protection workflow topology | License posture varies across modules; reference-only until verified |

Twenty is now indexed in the central store as a modern CRM UX reference. It remains AGPL/high-risk reference-only and should not displace nonprofit-native CiviCRM or SuiteCRM comparisons.
...
| OpenBoxes | Program logistics benchmark for nonprofits that distribute goods, supplies, or medical inventory | Inventory, warehouses, stock movements, shipments, receiving, fulfillment, operational reports | Track stock, prepare shipments, record receiving, reconcile inventory, support field program distribution | Program operations lead, logistics coordinator, clinic or warehouse staff, finance/admin reviewer | Lightweight logistics vocabulary, shipment state, stock movement audit, inventory/reporting boundaries | Central profile: `/Users/bryan/projects/reference-repos/docs/openboxes__openboxes.md` |
| KoboToolbox KPI | Field evidence and data-collection benchmark for humanitarian and program operations | Form projects, question libraries, sharing, submissions, reports, exports, API access | Design field forms, collect responses, share survey projects, export program evidence | Program evaluator, field coordinator, service delivery staff, data analyst | Field-evidence exports, project sharing, form/report separation, evidence collection boundaries | Central profile: `/Users/bryan/projects/reference-repos/docs/kobotoolbox__kpi.md` |
| DHIS2 Core | Program analytics and monitoring/evaluation benchmark | Organization units, indicators, analytics APIs, dashboards, program data | Define indicators, aggregate program data, review trends across org units, expose analytics | Executive director, program manager, data analyst, funder-reporting owner | Indicator and org-unit vocabulary, monitoring/evaluation reporting, program analytics posture | Central profile: `/Users/bryan/projects/reference-repos/docs/dhis2__dhis2-core.md` |
| OpenMRS Core | Structured service-evidence benchmark for health or rehab-adjacent workflows | Encounters, concepts, patients, programs, clinical observations | Record structured encounters, use concept dictionaries, connect service evidence to program context | Clinician-adjacent service staff, rehab coordinator, program evaluator | Encounter/concept vocabulary and structured evidence boundaries, not EMR parity | Central profile: `/Users/bryan/projects/reference-repos/docs/openmrs__openmrs-core.md` |
| openIMIS | Social-protection administration benchmark | Eligibility, policies, contributions, claims, payments, modular service topology | Determine eligibility, manage claims and payments, connect case and finance events | Benefits coordinator, finance/admin staff, program operations lead | Eligibility/payment-cycle vocabulary and modular service boundaries | Central profiles: `/Users/bryan/projects/reference-repos/docs/openimis__openimis-be_py.md`, `/Users/bryan/projects/reference-repos/docs/openimis__openimis-dist_dkr.md` |
...
- Use OpenBoxes, KoboToolbox, DHIS2, OpenMRS, and openIMIS only for future row definition until `P5-T111` clone-cache hygiene permits source-level review.
