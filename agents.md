...
- Middleware: [https://github.com/example/nonprofit-manager](https://github.com/example/nonprofit-manager)
...
| Portal Actions | [backend/src/controllers/portalController.ts](https://github.com/example/nonprofit-manager) | Log general portal activity |
