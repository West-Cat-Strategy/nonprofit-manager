...
VALUES
  ('aaaa1111-1111-1111-1111-111111111111', 'Community Food Bank', 'nonprofit', 'https://communityfoodbank.org', '555-0101', 'info@communityfoodbank.org', '400 Powell Street', 'Vancouver', 'BC', 'V6A 1G6', 'Canada', true, NOW()),
  ('aaaa2222-2222-2222-2222-222222222222', 'Youth Education Center', 'nonprofit', 'https://yec.org', '555-0102', 'contact@yec.org', '2050 Kingsway', 'Vancouver', 'BC', 'V5N 2T5', 'Canada', true, NOW()),
  ('aaaa3333-3333-3333-3333-333333333333', 'Green Earth Initiative', 'nonprofit', 'HTTPS://greenearth.org', '555-0103', 'hello@greenearth.org', '6111 River Road', 'Richmond', 'BC', 'V7C 0A2', 'Canada', true, NOW()),
  ('aaaa4444-4444-4444-4444-444444444444', 'Smith Family Foundation', 'foundation', 'https://smithfoundation.org', '555-0104', 'grants@smithfoundation.org', '1055 West Hastings Street', 'Vancouver', 'BC', 'V6E 2E9', 'Canada', true, NOW()),
  ('aaaa5555-5555-5555-5555-555555555555', 'TechCorp Industries', 'corporate', 'HTTPS://techcorp.com', '555-0105', 'partnerships@techcorp.com', '13450 102 Avenue', 'Surrey', 'BC', 'V3T 5X3', 'Canada', true, NOW())
...
VALUES
  ('cccc1111-1111-1111-1111-111111111111', 'Emily', 'Johnson', 'emily.johnson@email.com', '555-1001', NULL, NULL, true, '1985-03-15', 'Female', '123 Cambie Street', 'Vancouver', 'BC', 'V6B 2N3', 'Canada', 'email', NOW()),
  ('cccc2222-2222-2222-2222-222222222222', 'Michael', 'Chen', 'michael.chen@email.com', '555-1002', NULL, NULL, true, '1978-07-22', 'Male', '456 Main Street', 'Vancouver', 'BC', 'V6A 2T7', 'Canada', 'phone', NOW()),
  ('cccc3333-3333-3333-3333-333333333333', 'Sarah', 'Williams', 'sarah.williams@email.com', '555-1003', NULL, NULL, true, '1990-11-08', 'Female', '789 Canada Way', 'Burnaby', 'BC', 'V5G 1G3', 'Canada', 'email', NOW()),
  ('cccc4444-4444-4444-4444-444444444444', 'James', 'Rodriguez', 'james.rodriguez@email.com', '555-1004', NULL, NULL, true, '1982-01-30', 'Male', '321 Columbia Street', 'New Westminster', 'BC', 'V3L 1A6', 'Canada', 'email', NOW()),
  ('cccc5555-5555-5555-5555-555555555555', 'Amanda', 'Taylor', 'amanda.taylor@email.com', '555-1005', NULL, NULL, true, '1995-06-12', 'Female', '654 Lonsdale Avenue', 'North Vancouver', 'BC', 'V7M 2G7', 'Canada', 'email', NOW()),
  ('cccc6666-6666-6666-6666-666666666666', 'Robert', 'Martinez', 'robert.martinez@communityfoodbank.org', '555-1006', 'aaaa1111-1111-1111-1111-111111111111', 'Executive Director', true, '1970-04-18', 'Male', '400 Powell Street', 'Vancouver', 'BC', 'V6A 1G6', 'Canada', 'email', NOW()),
  ('cccc7777-7777-7777-7777-777777777777', 'Lisa', 'Anderson', 'lisa.anderson@yec.org', '555-1007', 'aaaa2222-2222-2222-2222-222222222222', 'Program Director', true, '1983-09-25', 'Female', '2050 Kingsway', 'Vancouver', 'BC', 'V5N 2T5', 'Canada', 'email', NOW()),
  ('cccc8888-8888-8888-8888-888888888888', 'David', 'Thompson', 'david.thompson@greenearth.org', '555-1008', 'aaaa3333-3333-3333-3333-333333333333', 'Volunteer Coordinator', true, '1988-12-03', 'Male', '6111 River Road', 'Richmond', 'BC', 'V7C 0A2', 'Canada', 'phone', NOW()),
  ('cccc9999-9999-9999-9999-999999999999', 'Jennifer', 'Smith', 'jennifer.smith@smithfoundation.org', '555-1009', 'aaaa4444-4444-4444-4444-444444444444', 'Grants Manager', true, '1975-05-20', 'Female', '1055 West Hastings Street', 'Vancouver', 'BC', 'V6E 2E9', 'Canada', 'email', NOW()),
  ('ccccaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Kevin', 'Brown', 'kevin.brown@techcorp.com', '555-1010', 'aaaa5555-5555-5555-5555-555555555555', 'CSR Director', true, '1980-08-14', 'Male', '13450 102 Avenue', 'Surrey', 'BC', 'V3T 5X3', 'Canada', 'email', NOW()),
  ('ccccbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Patricia', 'Garcia', 'patricia.garcia@email.com', '555-1011', NULL, NULL, true, '1992-02-28', 'Female', '111 Sixth Street', 'New Westminster', 'BC', 'V3L 3A1', 'Canada', 'email', NOW()),
  ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'Christopher', 'Lee', 'christopher.lee@email.com', '555-1012', NULL, NULL, true, '1987-10-05', 'Male', '222 Lonsdale Avenue', 'North Vancouver', 'BC', 'V7M 2G1', 'Canada', 'phone', NOW()),
  ('ccccdddd-dddd-dddd-dddd-dddddddddddd', 'Michelle', 'Wilson', 'michelle.wilson@email.com', '555-1013', NULL, NULL, true, '1993-07-17', 'Female', '333 Marine Drive', 'West Vancouver', 'BC', 'V7T 1A1', 'Canada', 'email', NOW()),
  ('cccceeee-eeee-eeee-eeee-eeeeeeeeeeee', 'Daniel', 'Harris', 'daniel.harris@email.com', '555-1014', NULL, NULL, true, '1979-04-09', 'Male', '444 Kingsway', 'Burnaby', 'BC', 'V5H 2A9', 'Canada', 'email', NOW()),
  ('ccccffff-ffff-ffff-ffff-ffffffffffff', 'Jessica', 'Clark', 'jessica.clark@email.com', '555-1015', NULL, NULL, true, '1991-11-23', 'Female', '555 Guildford Way', 'Surrey', 'BC', 'V3R 7B7', 'Canada', 'email', NOW())
ON CONFLICT (id) DO NOTHING;
