...
\i /migrations/126_cbis_staged_import_runs.sql
...
\i /migrations/133_webhook_endpoint_organization_scope.sql
\i /migrations/134_audit_request_context_metadata.sql
\i /migrations/135_organization_branding_tenant_scope.sql
\i /migrations/136_meeting_manager_tenant_scope.sql
...
VALUES
    ...
    ('133_webhook_endpoint_organization_scope.sql', '133', '133_webhook_endpoint_organization_scope.sql'),
    ('134_audit_request_context_metadata.sql', '134', '134_audit_request_context_metadata.sql'),
    ('135_organization_branding_tenant_scope.sql', '135', '135_organization_branding_tenant_scope.sql'),
    ('136_meeting_manager_tenant_scope.sql', '136', '136_meeting_manager_tenant_scope.sql')
