-- Migration: 134_audit_request_context_metadata.sql
-- Description: Capture request-context metadata in trigger-backed audit_log rows defensively.
...
BEGIN
  ...
  INSERT INTO audit_log (
    ...
    current_query(),
    v_is_sensitive,
    COALESCE(NULLIF(current_setting('app.environment', true), ''), 'production')
  );
