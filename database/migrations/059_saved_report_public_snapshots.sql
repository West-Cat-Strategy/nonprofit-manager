-- Migration 059: Public snapshot storage and lifecycle for saved report sharing
...
COMMENT ON TABLE saved_report_public_snapshots IS
  'Public sharing snapshots for saved reports (file-based CSV/XLSX artifacts)';
