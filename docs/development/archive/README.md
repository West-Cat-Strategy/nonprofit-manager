...
- Deleted unreferenced generated evidence from [../reference-patterns/](../reference-patterns/):
  - `P4-T2/license-report.json`
  - `P4-T2/source-scan.json`
  - `P4-T4F/license-report.json`
  - `P4-T4F/source-scan.json`
- Retained the markdown adoption specs, pattern catalogs, verification matrices, and backlog docs as the durable reference set.
