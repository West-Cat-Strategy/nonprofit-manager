...
The May 12 follow-up used the central profiles, `reference-repos/manifest.lock.json`, and current repo state while leaving the rebuildable clone cache absent. It opened [P5-T111 through P5-T119](../../validation/archive/P5-T111_T119_REFERENCE_REPO_IMPROVEMENT_SYNTHESIS_2026-05-12.md) as Ready rows in the live workboard.
