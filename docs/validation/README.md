...
| [P5-T13_GITHUB_CI_SECURITY_PILOT_2026-04-26.md](P5-T13_GITHUB_CI_SECURITY_PILOT_2026-04-26.md) | Row-local proof note | GitHub CI/security pilot closeout proof, PR #10/current-main reconciliation, required check contexts, repository security settings, and branch protection |
...
| [P5-T17_GITHUB_BUILD_ARTIFACTS_PROOF_2026-04-27.md](P5-T17_GITHUB_BUILD_ARTIFACTS_PROOF_2026-04-27.md) | Row-local proof note | Build-only GitHub artifact-validation proof, SBOM upload, strict required check context, and cleared secret-scanning alert follow-up |
