...
| [P5-T17_GITHUB_BUILD_ARTIFACTS_PROOF_2026-04-27.md](P5-T17_GITHUB_BUILD_ARTIFACTS_PROOF_2026-04-27.md) | Active validation note | Row-local proof tracker for the build-only GitHub artifact-validation gate, weekly schedules, SBOM upload, and branch-protection follow-up |
