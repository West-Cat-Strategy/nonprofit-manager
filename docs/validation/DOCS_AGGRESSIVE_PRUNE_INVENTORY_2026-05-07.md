...
| `backend/tests/integration/TEST_RESULTS_TEMPLATE.md`                   | Removed with the P5-T142 historical backend test-script cleanup; active docs now point to `docs/testing/archive/INTEGRATION_TESTING_PHASE2.md` for scenario context. |
| `backend/tests/manual/README.md`                                       | Removed with the P5-T142 manual event script cleanup; active docs now point to `docs/testing/archive/MANUAL_TESTING_GUIDE.md` for historical manual QA context. |
...
- Keep `AGENTS.md` as the canonical root orientation doc; `agents.md` is a compatibility pointer.
