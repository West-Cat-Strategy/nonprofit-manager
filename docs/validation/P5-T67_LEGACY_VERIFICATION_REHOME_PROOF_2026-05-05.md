...
- `docs/verification/VERIFICATION_SYSTEM.md` now describes the retained historical reproduction helpers rather than active signoff gates. The point-in-time PR #9 verification note was pruned during the 2026-05-07 docs cleanup.
