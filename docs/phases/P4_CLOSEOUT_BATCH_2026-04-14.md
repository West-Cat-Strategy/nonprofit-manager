...
- `P4-T13`, `P4-T14`, and `P4-T15`: the current Canadianized admin-settings helpers, the staff help-center manual, and the README-centric contributor path remain aligned with the row wording, and `make check-links` passed on 2026-04-14 with no broken active-doc links.
