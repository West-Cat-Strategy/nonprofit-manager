...
**Relevant Code:** [backend/src security](https://github.com/example/nonprofit-manager), [backend/src/services](https://github.com/example/nonprofit-manager)
...
- [Security Monitoring & Incident Response](https://github.com/example/nonprofit-manager) — Runtime security
