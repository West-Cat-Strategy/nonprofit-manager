...
**Files Created:**
- [`database/migrations/031_add_pii_encryption_fields.sql`](https://github.com/example/nonprofit-manager)
...
- [`backend/src/services/piiService.ts`](https://github.com/example/nonprofit-manager) (350+ lines)
