...
**Developer:** Bryan Crockett (@bcroc), Example Organization
...
**File:** [frontend/src/components/AvailabilityCalendar.tsx](https://github.com/example/nonprofit-manager)
...
**Integration:**
- Added to [VolunteerDetail.tsx](https://github.com/example/nonprofit-manager) as "Calendar" tab
- Connected to Redux store for real-time data
- Assignment detail modal on date click

#### TimeTracker Component
**File:** [frontend/src/components/TimeTracker.tsx](https://github.com/example/nonprofit-manager)
...
**Integration:**
- Added to [VolunteerDetail.tsx](https://github.com/example/nonprofit-manager) as "Time Tracker" tab
- Redux integration for hour updates
- Real-time assignment refresh

#### VolunteerWidget Component
**File:** [frontend/src/components/VolunteerWidget.tsx](https://github.com/example/nonprofit-manager)
...
**Integration:**
- Added to [Dashboard.tsx](https://github.com/example/nonprofit-manager)
...
**File:** [frontend/src/components/__tests__/AvailabilityCalendar.test.tsx](https://github.com/example/nonprofit-manager)
...
**File:** [frontend/src/components/__tests__/TimeTracker.test.tsx](https://github.com/example/nonprofit-manager)
...
**File:** [frontend/src/components/__tests__/VolunteerWidget.test.tsx](https://github.com/example/nonprofit-manager)
...
**File:** [docs/MANUAL_TESTING_GUIDE.md](https://github.com/example/nonprofit-manager)
...
2. **Follow Testing Guide**
   - Use [MANUAL_TESTING_GUIDE.md](https://github.com/example/nonprofit-manager)
...
- [Manual Testing Guide](https://github.com/example/nonprofit-manager)
- [Completion Roadmap](https://github.com/example/nonprofit-manager)

### Code References
- [AvailabilityCalendar Component](https://github.com/example/nonprofit-manager)
- [TimeTracker Component](https://github.com/example/nonprofit-manager)
- [VolunteerWidget Component](https://github.com/example/nonprofit-manager)
- [VolunteerDetail Page](https://github.com/example/nonprofit-manager)
- [Dashboard Page](https://github.com/example/nonprofit-manager)

### Test Files
- [AvailabilityCalendar Tests](https://github.com/example/nonprofit-manager)
- [TimeTracker Tests](https://github.com/example/nonprofit-manager)
- [VolunteerWidget Tests](https://github.com/example/nonprofit-manager)
