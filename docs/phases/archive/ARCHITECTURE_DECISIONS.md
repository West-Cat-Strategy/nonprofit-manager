...
**Relevant Code:** [backend/src architecture](https://github.com/example/nonprofit-manager)
...
- [ARCHITECTURE.md](https://github.com/example/nonprofit-manager) — Current architecture documentation
