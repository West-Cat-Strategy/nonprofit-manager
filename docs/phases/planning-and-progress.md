...
| P4-T1R5 | Full remaining `/api/v2` modularization sweep (backend-first, contract-stable) | Phase 4 | Ready | — | — | TBD | codex/p4-t1r5-full-v2-modular-sweep (parent: P4-T1) (queue: #11) |
| P4-T1R5A | Backend all-legacy-v2 module cutover (22 remaining domains) | Phase 4 | Blocked | Codex | Mar 3, 2026 | TBD | codex/p4-t1r5-full-v2-modular-sweep (parent: P4-T1R5) (What: Backend cutover work landed but final closure is unresolved. Why: Typecheck closure remained blocked by out-of-scope `caseService` TS errors during prior verification. Next step: Clear out-of-scope type blockers or isolate scope, rerun closure matrix, then move to Done.) |
| P4-T1R5B | Frontend admin/portal feature ownership cutover (`alerts/webhooks/mailchimp/portalAuth/adminOps`) | Phase 4 | Blocked | Codex | Mar 3, 2026 | TBD | codex/p4-t1r5-full-v2-modular-sweep (parent: P4-T1R5) (What: Frontend ownership cutover is implemented but closure is unresolved. Why: Parent stream lacks final full-gate closure artifact after policy/docs pass. Next step: Re-run targeted frontend + policy closure sequence and append final artifact.) |
| P4-T1R5C | Policy ratchets + modularity cleanup + documentation closure | Phase 4 | Blocked | Codex | Mar 3, 2026 | TBD | codex/p4-t1r5-full-v2-modular-sweep (parent: P4-T1R5) (What: Policy/documentation ratchets were implemented but closure remains pending. Why: Final stream closure evidence is incomplete due upstream type/blocker coupling. Next step: Complete stream-level verification handoff and promote when artifacts are attached.) |
