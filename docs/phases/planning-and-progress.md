...
| P4-T32 | Multi-type / multi-outcome cases refactor | Phase 4 | In Progress | Codex | Mar 29, 2026 | TBD | main (case-classification refactor lane; scope: multi-assigned case types, multi-valued case outcomes, compatibility mirrors, and targeted backend/frontend regression coverage.) |
