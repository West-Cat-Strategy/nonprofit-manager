...
**Last Updated:** March 8, 2026 (`P4-T1R6B`, `P4-T9C`, and `P4-T9F` moved `Review -> Done` after `main@74db868` was pushed and deployed to `example.com` via `./scripts/deploy.sh`, with remote/internal/public verification all passing.)  
