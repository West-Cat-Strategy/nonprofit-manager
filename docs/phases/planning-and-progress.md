...
| P4-T33 | Website console management cockpit upgrade | Phase 4 | Review | Codex | Mar 29, 2026 | TBD | main (website console control-center upgrade; scope: overview snapshot, content/form/integration/publishing guidance, and stronger list-entrypoint shortcuts with focused regression coverage.) |
