...
| Review | P5-T17 | GitHub build artifact validation | Add the build-only GitHub package-validation gate for Dockerfile validation and SBOM artifact upload; keep it free of staging/prod deployment secrets and require `Build Artifacts / docker-validate-sbom` after the first check context exists. |
...
- `P5-T17` is in `Review` for the build-only GitHub artifact-validation follow-up: Dockerfile validation and CycloneDX SBOM upload are approved, while deploy automation and additional scanner/tooling expansion remain out of scope.
...
| P5-T17 | GitHub build artifact validation | Review | Codex | Implementation adds the build-only `Build Artifacts / docker-validate-sbom` GitHub gate, weekly CodeQL/security/build validation schedules, Node 25 workflow parity, and Twilio fixture cleanup. Keep this row free of deploy automation and require the new check context after its first green run. | [../../.github/README.md](../../.github/README.md), [../testing/TESTING.md](../testing/TESTING.md), [../validation/P5-T17_GITHUB_BUILD_ARTIFACTS_PROOF_2026-04-27.md](../validation/P5-T17_GITHUB_BUILD_ARTIFACTS_PROOF_2026-04-27.md) |
