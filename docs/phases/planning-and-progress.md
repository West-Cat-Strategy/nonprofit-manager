...
| P3-T5 | Frontend case-priority critical drift causing `make ci-unit` TypeScript failures | Phase 3 | In Progress | Codex | Feb 24, 2026 | TBD | codex/p3-t5-case-priority-critical-ui |
...
| https://github.com/example/nonprofit-manager/blob/main/backend/src/routes/mailchimp.ts | express-validator | 8 | express-validator
...
| https://github.com/example/nonprofit-manager/blob/main/backend/src/routes/webhooks.ts | express-validator | 12 | express-validator
