...
| P4-T38 | Contacts module redesign + legacy alignment | Phase 4 | In Progress | Antigravity | Apr 10, 2026 | TBD | main (contacts list/detail/create/edit/merge UX cleanup, module/controller alignment, and focused regression coverage) |
| P4-T37 | Organizational admin panel refactor + canonical role wiring | Phase 4 | In Progress | Antigravity | Apr 10, 2026 | TBD | main (admin settings shell, canonical role catalog, audit-log reuse, and compatibility normalization lane) |
| P4-T39 | Reliability and efficiency remediation sweep | Phase 4 | In Progress | Codex | Apr 11, 2026 | TBD | main (backend reconciliation/payment safety, frontend render stability, and test/CI hardening lane) |
...
| P4-T31 | Dockerfile refactor and build optimization follow-up | Phase 4 | Review | Codex | Apr 11, 2026 | TBD | main (backend dev runtime now uses `node --watch` via package scripts; Dockerfile/compose cleanup is complete and validated with `make docker-validate` and `make docker-build`.) |
...
| P4-T39 | Backend reliability hardening (reconciliation, payments, webhooks) | Phase 4 | In Progress | Antigravity | Apr 11, 2026 | TBD | main |
| P4-T40 | LUKS-aware production deploy wrapper alignment | Phase 4 | Review | Codex | Apr 13, 2026 | TBD | main (validated with `make docker-validate`, `bash -n`, managed/LUKS dry-runs, and a successful host-managed production-style deploy; docs and env template updated to match.) |
