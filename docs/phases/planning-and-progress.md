...
| P4-T7I | Staff-first route audit + editorial shell redesign | Phase 4 | Review | Codex | Mar 5, 2026 | TBD | codex/p4-t7i-staff-ux-audit (parent: P4-T7; verification: `node scripts/ui-audit.ts` ✅, `make ci-full` ✅, Playwright inside CI `645 passed / 4 flaky / 2 skipped`.) |
