...
| P4-T7C | Core app pages migration (people/engagement/finance/analytics/admin/builder/workflows) | Phase 4 | In Progress | Codex | Apr 14, 2026 | TBD | main (active 2026-04-16: admin-settings hybrid hub refactor remains in flight across `/settings/admin/*`, and the current user-requested dashboard workspace overhaul is now refactoring `/dashboard` plus `/dashboard/custom` into feature-owned staff surfaces with shared workload/data hooks, responsive layout editing, and productivity-first defaults while keeping the public routes stable) |
