...
| P4-T26 | Staff help-center screenshot refresh (live PNG captures + docs gallery wiring) | Phase 4 | In Progress | Codex | Mar 19, 2026 | TBD | main (docs-only follow-up to P4-T14; replacing help-center screenshot placeholders with live captures under `docs/help-center/staff/assets/screenshots/`, keeping the landing/appendix docs-first captures, and refreshing dashboard wording to match the live UI.) |
