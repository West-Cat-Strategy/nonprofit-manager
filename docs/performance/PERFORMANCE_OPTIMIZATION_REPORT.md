...
**Files:** 
- [frontend/src/store/slices/casesSlice.ts](https://github.com/example/nonprofit-manager/blob/main/frontend/src/store/slices/casesSlice.ts)
- [frontend/src/store/slices/followUpsSlice.ts](https://github.com/example/nonprofit-manager/blob/main/frontend/src/store/slices/followUpsSlice.ts)
...
**File:** [frontend/src/pages/analytics/charts.tsx](https://github.com/example/nonprofit-manager/blob/main/frontend/src/pages/analytics/charts.tsx)
...
2. **Memoize CaseList handlers and formatters**
   - File: [pages/engagement/cases/CaseList.tsx](https://github.com/example/nonprofit-manager/blob/main/frontend/src/pages/engagement/cases/CaseList.tsx#L1)
