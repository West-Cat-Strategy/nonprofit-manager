...
| Doc | Use |
|---|---|
| [archive/README.md](archive/README.md) | Local index for retired product research and historical notes |
| [archive/PRODUCT_ANALYTICS_RESEARCH.md](archive/PRODUCT_ANALYTICS_RESEARCH.md) | Historical analytics vendor evaluation snapshot kept for context, not current product direction |
