...
exports.exportComprehensive = exports.exportEvents = exports.exportVolunteerHours = exports.exportDonations = exports.exportAnalyticsSummary = void 0;
...
const denyIfScopedExport = (scope, res) => {
    if (!scope)
        return false;
 ...
 */
const exportAnalyticsSummary = async (req, res, next) => {
    try {
        ...
        res.download(filepath, (err) => {
            if (err) {
                logger_1.logger.error('Error sending export file', { error: err, filepath });
            }
...
exports.exportAnalyticsSummary = exportAnalyticsSummary;
/**
 ...
 */
const exportVolunteerHours = async (req, res, next) => {
    try {
        const scope = req.dataScope?.filter;
        if (denyIfScopedExport(scope, res)) {
            return;
...
exports.exportVolunteerHours = exportVolunteerHours;
/**
 ...
 */
const exportComprehensive = async (req, res, next) => {
    try {
        const scope = req.dataScope?.filter;
        if (denyIfScopedExport(scope, res)) {
            return;
        }
        const format = req.body.format || 'excel'; // Excel recommended for multi-sheet
        const filters = {
            start_date: req.body.start_date,
            end_date: req.body.end_date,
        };
        ...
        LIMIT 1000`, [filters.start_date, filters.end_date]),
            database_1.default.query(`SELECT
          vh.log_date,
          vh.hours,
          vh.activity_type,
        ...
        ORDER BY e.start_date DESC`, [filters.start_date, filters.end_date]),
        ]);
...
exports.exportComprehensive = exportComprehensive;
exports.default = {
    exportAnalyticsSummary: exports.exportAnalyticsSummary,
    exportDonations: exports.exportDonations,
    exportVolunteerHours: exports.exportVolunteerHours,
    exportEvents: exports.exportEvents,
    exportComprehensive: exports.exportComprehensive,
};
