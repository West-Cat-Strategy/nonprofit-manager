 ...
 */
export type TemplateCategory = 'landing-page' | 'event' | 'donation' | 'blog' | 'multi-page' | 'portfolio' | 'contact';
/**
 * Template status
 */
 ...
 */
export type ComponentType = 'text' | 'heading' | 'image' | 'button' | 'form' | 'gallery' | 'video' | 'map' | 'social-links' | 'divider' | 'spacer' | 'columns' | 'hero' | 'card' | 'testimonial' | 'pricing' | 'faq' | 'contact-form' | 'donation-form' | 'event-list' | 'newsletter-signup' | 'countdown' | 'stats' | 'team' | 'logo-grid';
/**
 ...
 */
export type PageComponent = TextComponent | HeadingComponent | ImageComponent | ButtonComponent | FormComponent | GalleryComponent | VideoComponent | MapComponent | SocialLinksComponent | DividerComponent | SpacerComponent | ColumnsComponent | HeroComponent | CardComponent | TestimonialComponent | PricingComponent | FAQComponent | ContactFormComponent | DonationFormComponent | EventListComponent | NewsletterSignupComponent | CountdownComponent | StatsComponent | TeamComponent | LogoGridComponent;
/**
...
//# sourceMappingURL=websiteBuilder.d.ts.map