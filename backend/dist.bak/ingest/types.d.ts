...
export type InferredType = 'unknown' | 'string' | 'number' | 'currency' | 'boolean' | 'date' | 'datetime' | 'uuid' | 'email' | 'phone';
...
export type SchemaFieldType = 'string' | 'number' | 'boolean' | 'date' | 'datetime' | 'uuid' | 'enum';
