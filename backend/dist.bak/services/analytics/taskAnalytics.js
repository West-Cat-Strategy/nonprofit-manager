...
exports.TaskAnalyticsService = void 0;
...
class TaskAnalyticsService {
    ...
    async getTaskMetrics(entityType, entityId) {
      ...
      `;
            ...
            logger_1.logger.error('Error getting task metrics', { error, entityType, entityId });
            throw new Error('Failed to retrieve task metrics');
        }
    }
}
exports.TaskAnalyticsService = TaskAnalyticsService;
