...
exports.VolunteerAnalyticsService = void 0;
...
class VolunteerAnalyticsService {
    ...
    async getVolunteerMetrics(contactId) {
      ...
      `;
            ...
            logger_1.logger.error('Error getting volunteer metrics', { error, contactId });
    ...
    async getVolunteerHoursTrends(months = 12) {
      ...
      `;
            ...
            logger_1.logger.error('Error getting volunteer hours trends', { error });
            throw new Error('Failed to retrieve volunteer hours trends');
        }
    }
}
exports.VolunteerAnalyticsService = VolunteerAnalyticsService;
//# sourceMappingURL=volunteerAnalytics.js.map