...
async function createPaymentIntent(request) {
    ...
    try {
        ...
        logger_1.logger.error('Failed to create payment intent', { error, request });
        throw error;
    }
}
/**
...
async function getPaymentIntent(paymentIntentId) {
    ...
    try {
        ...
        logger_1.logger.error('Failed to retrieve payment intent', { error, paymentIntentId });
        throw error;
    }
}
/**
...
async function cancelPaymentIntent(paymentIntentId) {
    ...
    try {
        ...
        logger_1.logger.error('Failed to cancel payment intent', { error, paymentIntentId });
        throw error;
    }
}
/**
...
async function createRefund(request) {
    ...
    try {
        ...
        logger_1.logger.info('Refund created', {
            refundId: refund.id,
        ...
        logger_1.logger.error('Failed to create refund', { error, request });
        throw error;
    }
}
/**
...
async function createCustomer(request) {
    ...
    try {
        ...
        logger_1.logger.info('Customer created', { customerId: customer.id, email: customer.email });
        return {
            id: customer.id,
        ...
        logger_1.logger.error('Failed to create customer', { error, request });
        throw error;
    }
}
/**
...
async function getCustomer(customerId) {
    ...
    try {
        ...
        logger_1.logger.error('Failed to retrieve customer', { error, customerId });
        throw error;
    }
}
/**
...
async function listPaymentMethods(customerId) {
    ...
    try {
        ...
        logger_1.logger.error('Failed to list payment methods', { error, customerId });
        throw error;
    }
}
/**
...
async function createSubscription(request) {
    ...
    try {
        ...
        logger_1.logger.error('Failed to create subscription', { error, request });
        throw error;
    }
}
/**
