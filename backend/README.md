...
For detailed setup instructions, see [https://github.com/example/nonprofit-manager](https://github.com/example/nonprofit-manager) (coming soon) or [docs/development/GETTING_STARTED.md](../docs/development/GETTING_STARTED.md).
...
See [docs/testing/UNIT_TESTING.md](https://github.com/example/nonprofit-manager) for testing patterns.
...
- [docs/testing/UNIT_TESTING.md](https://github.com/example/nonprofit-manager) — Testing patterns
