...
const AUTH_REQUIRED_CASES: GuardrailCase[] = [
  ...
  {
    name: 'follow-ups list requires auth',
    method: 'get',
  ...
  {
    name: 'opportunities list requires auth',
    method: 'get',
  ...
  {
    name: 'scheduled reports list requires auth',
    method: 'get',
    path: '/api/v2/scheduled-reports',
    expectedStatus: 401,
    expectedCode: 'unauthorized',
  },
  {
    name: 'payment intent create requires auth',
    method: 'post',
    path: '/api/v2/payments/intents',
    expectedStatus: 401,
    expectedCode: 'unauthorized',
    payload: {
      amount: 500,
  ...
  {
    name: 'report generation requires auth',
    method: 'post',
  ...
  {
    name: 'report templates require auth',
    method: 'get',
    path: '/api/v2/reports/templates',
    expectedStatus: 401,
    expectedCode: 'unauthorized',
  },
  {
    name: 'saved reports list requires auth',
    method: 'get',
    path: '/api/v2/saved-reports',
    expectedStatus: 401,
    expectedCode: 'unauthorized',
  },
  {
    name: 'saved report create requires auth',
    method: 'post',
    path: '/api/v2/saved-reports',
    expectedStatus: 401,
    expectedCode: 'unauthorized',
    payload: {
      name: 'Guardrail saved report',
      entity: 'contacts',
      report_definition: {},
    },
  },
  {
    name: 'templates list requires auth',
    method: 'get',
  ...
  {
    name: 'template create requires auth',
    method: 'post',
    path: '/api/v2/templates',
    expectedStatus: 401,
    expectedCode: 'unauthorized',
  ...
  {
    name: 'reconciliation list requires auth',
    method: 'get',
    path: '/api/v2/reconciliation',
    expectedStatus: 401,
    expectedCode: 'unauthorized',
  },
  {
    name: 'reconciliation dashboard requires auth',
    method: 'get',
    path: '/api/v2/reconciliation/dashboard',
    expectedStatus: 401,
    expectedCode: 'unauthorized',
  },
  {
    name: 'ingest text preview requires auth',
    method: 'post',
    path: '/api/v2/ingest/preview-text',
    expectedStatus: 401,
    expectedCode: 'unauthorized',
    payload: {
      format: 'csv',
  ...
  {
    name: 'ingest upload preview requires auth',
    method: 'post',
    path: '/api/v2/ingest/preview',
    expectedStatus: 401,
    expectedCode: 'unauthorized',
  },
];
