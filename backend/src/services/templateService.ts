...
const defaultGlobalSettings: TemplateGlobalSettings = {
  language: 'en',
  header: {
    navigation: [],
    sticky: true,
...
function mapRowToTemplate(row: Record<string, unknown>): Template {
  return {
    ...
    globalSettings: row.global_settings as TemplateGlobalSettings,
 ...
 */
function mapRowToListItem(row: Record<string, unknown>): TemplateListItem {
 ...
 */
function mapRowToPage(row: Record<string, unknown>): TemplatePage {
  return {
    id: row.id as string,
    name: row.name as string,
 ...
 */
function convertToPublishedTheme(theme: TemplateTheme): PublishedTheme {
  return {
    colors: theme.colors,
 ...
 */
function convertToPublishedPage(page: TemplatePage): PublishedPage {
  return {
    id: page.id,
    slug: page.slug,
    name: page.name,
