...
import { parseCsv } from '@modules/cbisImport';
...
type Decision = 'merge_to_anchor' | 'keep_held';
...
interface DuplicateContactDecision {
...
export const loadDuplicateContactDecisions = async (
  ...
  const content = await fs.readFile(decisionAuditPath, 'utf8');
