...
export const AVAILABLE_FIELDS: Record<ReportEntity, ReportField[]> = {
  ...
  donations: [
    ...
    { field: 'appeal_campaign_id', label: 'Appeal/Campaign ID', type: 'string' },
    { field: 'appeal_campaign_name', label: 'Appeal/Campaign', type: 'string' },
    { field: 'appeal_campaign_code', label: 'Appeal/Campaign Code', type: 'string' },
    { field: 'appeal_campaign_kind', label: 'Appeal/Campaign Type', type: 'string' },
    { field: 'appeal_campaign_status', label: 'Appeal/Campaign Status', type: 'string' },
