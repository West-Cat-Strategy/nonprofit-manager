...
const VOLUNTEER_EXPORT_COLUMNS: Array<TabularExportColumn<ExportableVolunteerRow>> = [
  ...
  { key: 'preferred_roles', header: 'preferred_roles', width: 24, map: (row) => row.preferred_roles.join('; ') },
  ...
  { key: 'emergency_contact_relationship', header: 'emergency_contact_relationship', width: 24 },
