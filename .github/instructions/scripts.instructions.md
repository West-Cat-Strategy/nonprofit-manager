...
Do not add GitHub Actions workflows, hosted CI/CD, or GitHub MCP config from script-maintenance work unless the task explicitly approves that adoption. Keep scripts deterministic and document any new validation path in the testing docs or relevant phase proof note.
