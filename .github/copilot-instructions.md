...
- Treat `.github/workflows/**`, `.github/dependabot.yml`, dependency review, CodeQL, and secret-scan mirroring as approved only for the tracked GitHub CI/security pilot.
