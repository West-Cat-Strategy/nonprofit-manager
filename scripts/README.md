...
| ------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| [auth-alias-telemetry-review.mjs](auth-alias-telemetry-review.mjs) | Transform exported `auth.alias_input_used` and auth-route request-denominator logs into the P5-T75 route review, alias-event rollup, and exception-check tables for the June 17, 2026 auth-alias telemetry checkpoint.                              | `node scripts/auth-alias-telemetry-review.mjs --input tmp/auth-alias-june17-logs.ndjson --start 2026-06-01 --end 2026-06-16`                 |
