...
const backendAliasMap = [
  ...
  ['@services', path.join(repoRoot, 'backend/src/services/index.ts')],
  ...
  ['@validations', path.join(repoRoot, 'backend/src/validations/index.ts')],
  ['@middleware/', path.join(repoRoot, 'backend/src/middleware')],
  ['@middleware', path.join(repoRoot, 'backend/src/middleware/index.ts')],
